...
db_list = os.path.join(current, "VECTOR DB")
dbs = os.listdir(db_list)
print(dbs)
...
class documentsearchtool(BaseTool):
    ...
    def __init__(self, extension, file_path, db_path, collection_name, method):
        super().__init__()
...
if __name__ == "__main__":
    ...
    tool = documentsearchtool(
        ...
        db_path=os.path.join(current, "VECTOR DB"),
        collection_name="ruban",
        method = "retieve"
